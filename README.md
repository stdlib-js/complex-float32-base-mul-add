...
```javascript
import muladd from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-mul-add@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/complex-float32-base-mul-add/tags). For example,

```javascript
import muladd from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-mul-add@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign, strided } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-mul-add@deno/mod.js';
```
