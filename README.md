...
```javascript
import muladd from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-mul-add@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/complex-float32-base-mul-add/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/complex-float32-base-mul-add/actions/workflows/test.yml?query=branch:v0.1.1
