...
```javascript
import muladd from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-mul-add@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/complex-float32-base-mul-add/tags). For example,

```javascript
import muladd from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-mul-add@v0.1.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign, strided } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-mul-add@esm/index.mjs';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/complex-float32-base-mul-add.svg
[npm-url]: https://npmjs.org/package/@stdlib/complex-float32-base-mul-add

[test-image]: https://github.com/stdlib-js/complex-float32-base-mul-add/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/complex-float32-base-mul-add/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/complex-float32-base-mul-add/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/complex-float32-base-mul-add?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/complex-float32-base-mul-add.svg
[dependencies-url]: https://david-dm.org/stdlib-js/complex-float32-base-mul-add/main
...
[deno-url]: https://github.com/stdlib-js/complex-float32-base-mul-add/tree/deno
[deno-readme]: https://github.com/stdlib-js/complex-float32-base-mul-add/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/complex-float32-base-mul-add/tree/umd
[umd-readme]: https://github.com/stdlib-js/complex-float32-base-mul-add/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/complex-float32-base-mul-add/tree/esm
[esm-readme]: https://github.com/stdlib-js/complex-float32-base-mul-add/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/complex-float32-base-mul-add/blob/main/branches.md
